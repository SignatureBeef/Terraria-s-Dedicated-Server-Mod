...
##Existing plugins
This will serve as a "known" plugin list until out website is complete.
...
- [RenWorld](https://github.com/D1G1T4L3CH0/TDSM-RenWorld-Plugin) - [Lua] Allows you to rename a world
