...
namespace tdsm.api.Callbacks
{
    ...
    public static class NetplayCallback
    {
        ...
        public static void SendAnglerQuest()
        {
            ...
            if (Terraria.Netplay.serverSock != null)
                for (int i = 0; i < 255; i++)
                {
                    ...
                    {
                        NetMessageCallback.SendData(Packet.ANGLER_QUEST, i, -1, Terraria.Main.player[i].name, Terraria.Main.anglerQuest, 0f, 0f, 0f, 0);
                    }
                }
#endif
        }
        ...
        //                    {
        //                        var sx = Terraria.Netplay.GetSectionX(x);
        //                        var sy = Terraria.Netplay.GetSectionX(y);
        //                        if (Terraria.Netplay.serverSock[i].tileSection[sx, sy])
        //                        {
        //                            NetMessageCallback.SendData(Packet.FLOW_LIQUID, i, -1, String.Empty, x, (float)y, 0f, 0f, 0);
        //                        }
        //                    }
        //                }
        //#endif
