...
namespace Languages.Translation {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Languages.Translation.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public Languages.Translation.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="Translation.LanguageService")]
    public interface LanguageService {
        ...
        Languages.Translation.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, Languages.Translation.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, Languages.Translation.Translation[] translations, string from, string to, Languages.Translation.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        Languages.Translation.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, Languages.Translation.TranslateOptions options);
        ...
        Languages.Translation.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, Languages.Translation.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : Languages.Translation.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<Languages.Translation.LanguageService>, Languages.Translation.LanguageService {
        ...
        public Languages.Translation.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, Languages.Translation.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, Languages.Translation.Translation[] translations, string from, string to, Languages.Translation.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public Languages.Translation.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, Languages.Translation.TranslateOptions options) {
        ...
        public Languages.Translation.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, Languages.Translation.TranslateOptions options) {
