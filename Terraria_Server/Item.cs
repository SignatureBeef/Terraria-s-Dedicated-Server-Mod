            ...
            if (this.active)
            {
                ...
                if (!this.beingGrabbed)
                {
                        ...
                        if (!this.wet)
                        {
                            if (this.wetCount == 0)
                            {
                                ...
                                if (!flag)
                                {
                                    for (int j = 0; j < 10; j++)
                                    {
                                        Vector2 arg_253_0 = new Vector2(this.position.X - 6f, this.position.Y + (float)(this.height / 2) - 8f);
                                        int arg_253_1 = this.width + 12;
                                        int arg_253_2 = 24;
                                        int arg_253_3 = 33;
                                        float arg_253_4 = 0f;
                                        float arg_253_5 = 0f;
                                        ...
                                        int num3 = Dust.NewDust(arg_253_0, arg_253_1, arg_253_2, arg_253_3, arg_253_4, arg_253_5, arg_253_6, newColor, 1f);
                                        Dust expr_267_cp_0 = Main.dust[num3];
                                        expr_267_cp_0.velocity.Y = expr_267_cp_0.velocity.Y - 4f;
                                        Dust expr_285_cp_0 = Main.dust[num3];
                                        expr_285_cp_0.velocity.X = expr_285_cp_0.velocity.X * 2.5f;
                                ...
                                else
                                {
                                    for (int j = 0; j < 5; j++)
                                    {
                                        Vector2 arg_364_0 = new Vector2(this.position.X - 6f, this.position.Y + (float)(this.height / 2) - 8f);
                                        int arg_364_1 = this.width + 12;
                                        int arg_364_2 = 24;
                                        int arg_364_3 = 35;
                                        float arg_364_4 = 0f;
                                        float arg_364_5 = 0f;
                                        int arg_364_6 = 0;
                                        Color newColor = default(Color);
                                        int num3 = Dust.NewDust(arg_364_0, arg_364_1, arg_364_2, arg_364_3, arg_364_4, arg_364_5, arg_364_6, newColor, 1f);
                                        Dust expr_378_cp_0 = Main.dust[num3];
                                        expr_378_cp_0.velocity.Y = expr_378_cp_0.velocity.Y - 1.5f;
                                        Dust expr_396_cp_0 = Main.dust[num3];
                                        expr_396_cp_0.velocity.X = expr_396_cp_0.velocity.X * 2.5f;
                                        Main.dust[num3].scale = 1.3f;
                                        Main.dust[num3].alpha = 100;
                                        Main.dust[num3].noGravity = true;
                                    }
                    ...
                    if (this.type == 75 && Main.dayTime)
                    {
                        for (int k = 0; k < 10; k++)
                        {
                            Vector2 arg_626_0 = this.position;
                            int arg_626_1 = this.width;
                            int arg_626_2 = this.height;
                            int arg_626_3 = 15;
                            float arg_626_4 = this.velocity.X;
                            float arg_626_5 = this.velocity.Y;
                            int arg_626_6 = 150;
                            Color newColor = default(Color);
                            Dust.NewDust(arg_626_0, arg_626_1, arg_626_2, arg_626_3, arg_626_4, arg_626_5, arg_626_6, newColor, 1.2f);
                        }
                        for (int k = 0; k < 3; k++)
                        {
                ...
                if (this.type == 75)
                {
                    ...
                    {
                        Vector2 arg_837_0 = this.position;
                        int arg_837_1 = this.width;
                        int arg_837_2 = this.height;
                        int arg_837_3 = 15;
                        float arg_837_4 = this.velocity.X * 0.5f;
                        float arg_837_5 = this.velocity.Y * 0.5f;
                        int arg_837_6 = 150;
                        Color newColor = default(Color);
                        Dust.NewDust(arg_837_0, arg_837_1, arg_837_2, arg_837_3, arg_837_4, arg_837_5, arg_837_6, newColor, 1.2f);
                    }
        ...
        public void FindOwner(int whoAmI)
        {
            if (this.keepTime <= 0)
            {
                ...
                for (int i = 0; i < 255; i++)
                {
                    if (this.ownIgnore != i)
                    {
                        if (Main.player[i].active && Main.player[i].ItemSpace(Main.item[whoAmI]))
                        {
                            ...
                            if (num3 < (float)(Main.screenWidth / 2 + Main.screenHeight / 2))
                            {
                ...
                if (this.owner != num)
                {
                    if ((num == Main.myPlayer && Main.netMode == 1) || (num == 255 && Main.netMode == 2) || !Main.player[num].active)
                    {
