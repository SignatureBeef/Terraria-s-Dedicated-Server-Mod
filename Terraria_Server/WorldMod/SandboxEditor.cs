...
namespace Terraria_Server.WorldMod
{
	public interface ISandbox
	{
		...
		void SetLiquidAt (int x, int y, byte val);
...
//		}
		...
		where TBox : ISandbox
	{
		...
		struct TRef
		{
			...
			public byte Liquid { get { return editor.sandbox.LiquidAt (x, y); } }
			public void SetLiquid (byte val)
			{
				editor.sandbox.SetLiquidAt (x, y, val);
			}
