...
namespace Terraria_Server
{
	public class Main
	{
        ...
        private static void UpdateTime()
        {
            ...
            {
                ProgramLog.Error.Log("UpdateLighting method error: {0}", e.Message);
            }
        }
        ...
        public static void UpdateLighting()
        {
            ...
            Color white2 = new Color(255, 255, 255, 255);
            Color white3 = new Color(255, 255, 255, 255);
            float biomeModifier;
            int r, g, b;
            ...
            if (Main.dayTime)
            {
                ...
                {
                    biomeModifier = (float)(Main.time / 13500.0);
                    white2.R = (byte)(biomeModifier * 200f + 55f);
                    white2.G = (byte)(biomeModifier * 180f + 75f);
                    white2.B = (byte)(biomeModifier * 250f + 5f);
                    white.R = (byte)(biomeModifier * 200f + 55f);
                    white.G = (byte)(biomeModifier * 200f + 55f);
                    white.B = (byte)(biomeModifier * 200f + 55f);
                }
                if (Main.time > 45900.0)
                {
                    biomeModifier = (float)(1.0 - (Main.time / 54000.0 - 0.85) * 6.666666666666667);
                    white2.R = (byte)(biomeModifier * 120f + 55f);
                    white2.G = (byte)(biomeModifier * 100f + 25f);
                    white2.B = (byte)(biomeModifier * 120f + 55f);
                    white.R = (byte)(biomeModifier * 200f + 55f);
                    white.G = (byte)(biomeModifier * 85f + 55f);
                    white.B = (byte)(biomeModifier * 135f + 55f);
                }
                else if (Main.time > 37800.0)
                {
                    biomeModifier = (float)(1.0 - (Main.time / 54000.0 - 0.7) * 6.666666666666667);
                    white2.R = (byte)(biomeModifier * 80f + 175f);
                    white2.G = (byte)(biomeModifier * 130f + 125f);
                    white2.B = (byte)(biomeModifier * 100f + 155f);
                    white.R = (byte)(biomeModifier * 0f + 255f);
                    white.G = (byte)(biomeModifier * 115f + 140f);
                    white.B = (byte)(biomeModifier * 75f + 180f);
                }
            }
            if (!Main.dayTime)
            {
                if (Main.bloodMoon)
                {
                    ...
                    {
                        biomeModifier = (float)(1.0 - Main.time / 16200.0);
                        white3.R = (byte)(biomeModifier * 10f + 205f);
                        white3.G = (byte)(biomeModifier * 170f + 55f);
                        white3.B = (byte)(biomeModifier * 200f + 55f);
                        white.R = (byte)(60f - biomeModifier * 60f + 55f);
                        white.G = (byte)(biomeModifier * 40f + 15f);
                        white.B = (byte)(biomeModifier * 40f + 15f);
                    }
                    else if (Main.time >= 16200.0)
                    {
                        biomeModifier = (float)((Main.time / 32400.0 - 0.5) * 2.0);
                        white3.R = (byte)(biomeModifier * 50f + 205f);
                        white3.G = (byte)(biomeModifier * 100f + 155f);
                        white3.B = (byte)(biomeModifier * 100f + 155f);
                        white3.R = (byte)(biomeModifier * 10f + 205f);
                        white3.G = (byte)(biomeModifier * 170f + 55f);
                        white3.B = (byte)(biomeModifier * 200f + 55f);
                        white.R = (byte)(60f - biomeModifier * 60f + 55f);
                ...
                else if (Main.time < 16200.0)
                {
                    biomeModifier = (float)(1.0 - Main.time / 16200.0);
                    white3.R = (byte)(biomeModifier * 10f + 205f);
                    white3.G = (byte)(biomeModifier * 70f + 155f);
                    white3.B = (byte)(biomeModifier * 100f + 155f);
                    white.R = (byte)(biomeModifier * 40f + 15f);
                    white.G = (byte)(biomeModifier * 40f + 15f);
                    white.B = (byte)(biomeModifier * 40f + 15f);
                }
                else if (Main.time >= 16200.0)
            ...
            if (Main.evilTiles > 0)
            {
                biomeModifier = (float)Main.evilTiles / 500f;
                if (biomeModifier > 1f)
                {
                    biomeModifier = 1f;
                }
                ...
                g = (int)white.G;
                b = (int)white.B;
                r += (int)(10f * biomeModifier);
                g -= (int)(90f * biomeModifier * ((float)white.G / 255f));
                b -= (int)(190f * biomeModifier * ((float)white.B / 255f));
                if (r > 255)
                {
                    r = 255;
                }
                ...
                g = (int)white2.G;
                b = (int)white2.B;
                r -= (int)(100f * biomeModifier * ((float)white2.R / 255f));
                g -= (int)(160f * biomeModifier * ((float)white2.G / 255f));
                b -= (int)(170f * biomeModifier * ((float)white2.B / 255f));
                if (r < 15)
                {
                    r = 15;
                }
                ...
                g = (int)white3.G;
                b = (int)white3.B;
                r -= (int)(140f * biomeModifier * ((float)white3.R / 255f));
                g -= (int)(170f * biomeModifier * ((float)white3.G / 255f));
                b -= (int)(190f * biomeModifier * ((float)white3.B / 255f));
                if (r < 15)
                {
                    r = 15;
                }
            ...
            {
                biomeModifier = (float)Main.jungleTiles / 200f;
                if (biomeModifier > 1f)
                {
                    biomeModifier = 1f;
                }
                ...
                g = (int)white.G;
                b = (int)white.B;
                r -= (int)(20f * biomeModifier * ((float)white.R / 255f));
                b -= (int)(120f * biomeModifier * ((float)white.B / 255f));
                if (g > 255)
                {
                    g = 255;
                }
                ...
                g = (int)white2.G;
                b = (int)white2.B;
                g -= (int)(10f * biomeModifier * ((float)white2.G / 255f));
                r -= (int)(50f * biomeModifier * ((float)white2.R / 255f));
                b -= (int)(10f * biomeModifier * ((float)white2.B / 255f));
                if (r < 15)
                {
                    r = 15;
                }
                ...
                g = (int)white3.G;
                b = (int)white3.B;
                g -= (int)(140f * biomeModifier * ((float)white3.R / 255f));
                r -= (int)(170f * biomeModifier * ((float)white3.G / 255f));
                b -= (int)(190f * biomeModifier * ((float)white3.B / 255f));
                if (r < 15)
                {
                    r = 15;
            ...
            int startX = (int)(Main.screenPosition.X / 16f - 1f);
            int stopX = (int)((Main.screenPosition.X + (float)Main.screenWidth) / 16f) + 2;
            int startY = (int)(Main.screenPosition.Y / 16f - 1f);
            int stopY = (int)((Main.screenPosition.Y + (float)Main.screenHeight) / 16f) + 2;
            if (startX < 0)
            {
                startX = 0;
            }
            if (stopX > Main.maxTilesX)
            {
                stopX = Main.maxTilesX;
            }
            if (startY < 0)
            {
                startY = 0;
            }
            if (stopY > Main.maxTilesY)
            {
                stopY = Main.maxTilesY;
            }
            Lighting.LightTiles(startX, stopX, startY, stopY);
        }
