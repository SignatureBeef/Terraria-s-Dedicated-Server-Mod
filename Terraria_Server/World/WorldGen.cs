...
namespace Terraria_Server.Generation
{
	class WorldGen
	{
		...
		public static void generateWorld(int seed = -1)
		{
			...
			if (seed > 0)
			{
				WorldMod.genRand = new Random(seed);
			}
			else
			{
				WorldMod.genRand = new Random((int)DateTime.Now.Ticks);
			}
			Main.worldID = WorldMod.genRand.Next(2147483647);
			int num = 0;
			int num2 = 0;
			double num3 = (double)Main.maxTilesY * 0.3;
			num3 *= (double)WorldMod.genRand.Next(90, 110) * 0.005;
			double num4 = num3 + (double)Main.maxTilesY * 0.2;
			num4 *= (double)WorldMod.genRand.Next(90, 110) * 0.01;
			double num5 = num3;
			double num6 = num3;
			double num7 = num4;
			double num8 = num4;
			...
			using (var prog = new ProgressLogger(Main.maxTilesX - 1, "Generating world terrain"))
			{
				for (int i = 0; i < Main.maxTilesX; i++)
				{
					...
					if (num2 <= 0)
					{
						num = WorldMod.genRand.Next(0, 5);
						num2 = WorldMod.genRand.Next(5, 40);
						if (num == 0)
						{
							num2 *= (int)((double)WorldMod.genRand.Next(5, 30) * 0.2);
						}
					}
					num2--;
					if (num == 0)
					{
						while (WorldMod.genRand.Next(0, 7) == 0)
						{
							num3 += (double)WorldMod.genRand.Next(-1, 2);
						}
					}
					else if (num == 1)
					{
						while (WorldMod.genRand.Next(0, 4) == 0)
						{
							num3 -= 1.0;
						}
						while (WorldMod.genRand.Next(0, 10) == 0)
						{
							num3 += 1.0;
						}
					}
					...
					{
						while (WorldMod.genRand.Next(0, 2) == 0)
						{
							num3 -= 1.0;
						}
						while (WorldMod.genRand.Next(0, 6) == 0)
						{
							num3 += 1.0;
						}
					}
					else if (num == 4)
					{
						...
						while (WorldMod.genRand.Next(0, 5) == 0)
						{
							num3 -= 1.0;
						}
					}
					...
					while (WorldMod.genRand.Next(0, 3) == 0)
					{
						num4 += (double)WorldMod.genRand.Next(-2, 3);
					}
			...
			WorldMod.waterLine = (int)(Main.rockLayer + (double)Main.maxTilesY) / 2;
			WorldMod.waterLine += WorldMod.genRand.Next(-100, 20);
			WorldMod.lavaLine = WorldMod.waterLine + WorldMod.genRand.Next(50, 80);
			int num13 = 0;

			ProgramLog.Log("Adding sand...");
			int num14 = WorldMod.genRand.Next((int)((double)Main.maxTilesX * 0.0007), (int)((double)Main.maxTilesX * 0.002));
			num14 += 2;
			for (int k = 0; k < num14; k++)
			{
				int num15 = WorldMod.genRand.Next(Main.maxTilesX);
				while ((float)num15 > (float)Main.maxTilesX * 0.45f && (float)num15 < (float)Main.maxTilesX * 0.55f)
				{
					num15 = WorldMod.genRand.Next(Main.maxTilesX);
				}
				int num16 = WorldMod.genRand.Next(35, 90);
				if (k == 1)
				{
					float num17 = (float)(Main.maxTilesX / 4200);
					num16 += (int)((float)WorldMod.genRand.Next(20, 40) * num17);
				}
				if (WorldMod.genRand.Next(3) == 0)
				{
					num16 *= 2;
				}
				if (k == 1)
				...
				num16 = WorldMod.genRand.Next(35, 90);
				if (WorldMod.genRand.Next(3) == 0)
				{
					num16 *= 2;
				}
				...
				{
					num18 = 0;
					num19 = WorldMod.genRand.Next(260, 300);
					if (num9 == 1)
					{
						num19 += 40;
					}
				...
				{
					num18 = Main.maxTilesX - WorldMod.genRand.Next(260, 300);
					num19 = Main.maxTilesX;
					if (num9 == -1)
					{
						num18 -= 40;
				...
				int num20 = WorldMod.genRand.Next(50, 100);
				for (int l = num18; l < num19; l++)
				{
					if (WorldMod.genRand.Next(2) == 0)
					{
						num20 += WorldMod.genRand.Next(-1, 2);
						if (num20 < 50)
						{
							num20 = 50;
						}
					...
					while ((double)num21 < Main.worldSurface)
					{
						if (Main.tile.At(l, num21).Active)
						{
							...
							num22 += WorldMod.genRand.Next(5);
							for (int m = num21; m < num21 + num22; m++)
							{
								if (l > num18 + WorldMod.genRand.Next(5) && l < num19 - WorldMod.genRand.Next(5))
								{
			...
			{
				TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)Main.worldSurface, (int)Main.rockLayer), (double)WorldMod.genRand.Next(15, 70), WorldMod.genRand.Next(20, 130), 53, false, 0f, 0f, false, true);
			}
			numMCaves = 0;
			...
			for (int num23 = 0; num23 < (int)((double)Main.maxTilesX * 0.0008); num23++)
			{
				...
				bool flag = false;
				bool flag2 = false;
				int num25 = WorldMod.genRand.Next((int)((double)Main.maxTilesX * 0.25), (int)((double)Main.maxTilesX * 0.75));
				while (!flag2)
				{
					flag2 = true;
					while (num25 > Main.maxTilesX / 2 - 100 && num25 < Main.maxTilesX / 2 + 100)
					{
						num25 = WorldMod.genRand.Next((int)((double)Main.maxTilesX * 0.25), (int)((double)Main.maxTilesX * 0.75));
					}
			...
			using (var prog = new ProgressLogger(Main.maxTilesX - 3, "Putting dirt behind dirt"))
			{
				for (int num28 = 1; num28 < Main.maxTilesX - 1; num28++)
				{
					...
					bool flag3 = false;
					num13 += WorldMod.genRand.Next(-1, 2);
					if (num13 < 0)
					{
						num13 = 0;
					}
			...
			{
				TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next(0, (int)num5 + 1), (double)WorldMod.genRand.Next(4, 15), WorldMod.genRand.Next(5, 40), 1, false, 0f, 0f, false, true);
			}
			for (int num32 = 0; num32 < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 0.0002); num32++)
			{
				TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num5, (int)num6 + 1), (double)WorldMod.genRand.Next(4, 10), WorldMod.genRand.Next(5, 30), 1, false, 0f, 0f, false, true);
			}
			for (int num33 = 0; num33 < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 0.0045); num33++)
			{
				TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num6, (int)num8 + 1), (double)WorldMod.genRand.Next(2, 7), WorldMod.genRand.Next(2, 23), 1, false, 0f, 0f, false, true);
			}

			ProgramLog.Log("Placing dirt in the rocks...");
			for (int num34 = 0; num34 < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 0.005); num34++)
			{
				TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num7, Main.maxTilesY), (double)WorldMod.genRand.Next(2, 6), WorldMod.genRand.Next(2, 40), 0, false, 0f, 0f, false, true);
			}

			ProgramLog.Log("Adding clay...");
			for (int num35 = 0; num35 < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 2E-05); num35++)
			{
				TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next(0, (int)num5), (double)WorldMod.genRand.Next(4, 14), WorldMod.genRand.Next(10, 50), 40, false, 0f, 0f, false, true);
			}
			for (int num36 = 0; num36 < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 5E-05); num36++)
			{
				TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num5, (int)num6 + 1), (double)WorldMod.genRand.Next(8, 14), WorldMod.genRand.Next(15, 45), 40, false, 0f, 0f, false, true);
			}
			for (int num37 = 0; num37 < (int)((double)(Main.maxTilesX * Main.maxTilesY) * 2E-05); num37++)
			{
				TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num6, (int)num8 + 1), (double)WorldMod.genRand.Next(8, 15), WorldMod.genRand.Next(5, 50), 40, false, 0f, 0f, false, true);
			}
			...
			using (var prog = new ProgressLogger(num41max - 1, "Making random holes"))
				for (int num41 = 0; num41 < num41max; num41++)
				{
					...
					int type = -1;
					if (WorldMod.genRand.Next(5) == 0)
					{
						type = -2;
					}
					TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num6, Main.maxTilesY), (double)WorldMod.genRand.Next(2, 5), WorldMod.genRand.Next(2, 20), type, false, 0f, 0f, false, true);
					TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num6, Main.maxTilesY), (double)WorldMod.genRand.Next(8, 15), WorldMod.genRand.Next(7, 30), type, false, 0f, 0f, false, true);
				}
			...
			using (var prog = new ProgressLogger(num43max - 1, "Generating small caves"))
				for (int num43 = 0; num43 < num43max; num43++)
				{
					...
					{
						int type2 = -1;
						if (WorldMod.genRand.Next(6) == 0)
						{
							type2 = -2;
						}
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num5, (int)num8 + 1), (double)WorldMod.genRand.Next(5, 15), WorldMod.genRand.Next(30, 200), type2, false, 0f, 0f, false, true);
					}
				}
			...
			using (var prog = new ProgressLogger(num45max - 1, "Generating large caves"))
				for (int num45 = 0; num45 < num45max; num45++)
				{
					...
					{
						int type3 = -1;
						if (WorldMod.genRand.Next(10) == 0)
						{
							type3 = -2;
						}
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num8, Main.maxTilesY), (double)WorldMod.genRand.Next(6, 20), WorldMod.genRand.Next(50, 300), type3, false, 0f, 0f, false, true);
					}
				}
			...
			{
				int num48 = WorldMod.genRand.Next(0, Main.maxTilesX);
				int num49 = 0;
				while ((double)num49 < num6)
				{
					if (Main.tile.At(num48, num49).Active)
					{
						TileRunner(num48, num49, (double)WorldMod.genRand.Next(3, 6), WorldMod.genRand.Next(5, 50), -1, false, (float)WorldMod.genRand.Next(-10, 11) * 0.1f, 1f, false, true);
						break;
					}
					num49++;
				}
			...
			for (int num50 = 0; num50 < (int)((double)Main.maxTilesX * 0.0007); num50++)
			{
				...
				while ((double)num51 < num6)
				{
					...
					{
						TileRunner(num48, num51, (double)WorldMod.genRand.Next(10, 15), WorldMod.genRand.Next(50, 130), -1, false, (float)WorldMod.genRand.Next(-10, 11) * 0.1f, 2f, false, true);
						break;
					}
					num51++;
				}
			...
			for (int num52 = 0; num52 < (int)((double)Main.maxTilesX * 0.0003); num52++)
			{
				...
				while ((double)num53 < num6)
				{
					...
					{
						TileRunner(num48, num53, (double)WorldMod.genRand.Next(12, 25), WorldMod.genRand.Next(150, 500), -1, false, (float)WorldMod.genRand.Next(-10, 11) * 0.1f, 4f, false, true);
						TileRunner(num48, num53, (double)WorldMod.genRand.Next(8, 17), WorldMod.genRand.Next(60, 200), -1, false, (float)WorldMod.genRand.Next(-10, 11) * 0.1f, 2f, false, true);
						TileRunner(num48, num53, (double)WorldMod.genRand.Next(5, 13), WorldMod.genRand.Next(40, 170), -1, false, (float)WorldMod.genRand.Next(-10, 11) * 0.1f, 2f, false, true);
						break;
					}
					num53++;
				}
			...
			for (int num54 = 0; num54 < (int)((double)Main.maxTilesX * 0.0004); num54++)
			{
				...
				while ((double)num55 < num6)
				{
					...
					{
						TileRunner(num48, num55, (double)WorldMod.genRand.Next(7, 12), WorldMod.genRand.Next(150, 250), -1, false, 0f, 1f, true, true);
						break;
					}
					num55++;
				}
			...
			{
				int num57 = WorldMod.genRand.Next(1, Main.maxTilesX - 1);
				int num58 = WorldMod.genRand.Next((int)num5, (int)num6);
				...
				num57 = WorldMod.genRand.Next(1, Main.maxTilesX - 1);
				num58 = WorldMod.genRand.Next(0, (int)num5);
				if (num58 >= Main.maxTilesY)
				{
					num58 = Main.maxTilesY - 2;
				}
			...
			using (var jungleprog = new ProgressLogger(100, "Generating jungle"))
			{
				...
				num59 *= 1.5f;
				int num60 = 0;
				float num61 = (float)WorldMod.genRand.Next(15, 30) * 0.01f;
				if (num9 == -1)
				{
					num61 = 1f - num61;
				...
				num60 += WorldMod.genRand.Next((int)(-100f * num59), (int)(101f * num59));
				num62 += WorldMod.genRand.Next((int)(-100f * num59), (int)(101f * num59));
				int num63 = num60;
				int num64 = num62;
				TileRunner(num60, num62, (double)WorldMod.genRand.Next((int)(250f * num59), (int)(500f * num59)), WorldMod.genRand.Next(50, 150), 59, false, (float)(num9 * 3), 0f, false, true);

				jungleprog.Value = 15;

				num60 += WorldMod.genRand.Next((int)(-250f * num59), (int)(251f * num59));
				num62 += WorldMod.genRand.Next((int)(-150f * num59), (int)(151f * num59));
				int num65 = num60;
				int num66 = num62;
				int num67 = num60;
				int num68 = num62;
				TileRunner(num60, num62, (double)WorldMod.genRand.Next((int)(250f * num59), (int)(500f * num59)), WorldMod.genRand.Next(50, 150), 59, false, 0f, 0f, false, true);

				jungleprog.Value = 30;

				num60 += WorldMod.genRand.Next((int)(-400f * num59), (int)(401f * num59));
				num62 += WorldMod.genRand.Next((int)(-150f * num59), (int)(151f * num59));
				int num69 = num60;
				int num70 = num62;
				TileRunner(num60, num62, (double)WorldMod.genRand.Next((int)(250f * num59), (int)(500f * num59)), WorldMod.genRand.Next(50, 150), 59, false, (float)(num9 * -3), 0f, false, true);
				...
				TileRunner(num60, num62, (double)WorldMod.genRand.Next((int)(400f * num59), (int)(600f * num59)), 10000, 59, false, 0f, -20f, true, true);
				...
				while ((float)num71 <= 20f * num59)
				{
					...
					num60 += WorldMod.genRand.Next((int)(-5f * num59), (int)(6f * num59));
					num62 += WorldMod.genRand.Next((int)(-5f * num59), (int)(6f * num59));
					TileRunner(num60, num62, (double)WorldMod.genRand.Next(40, 100), WorldMod.genRand.Next(300, 500), 59, false, 0f, 0f, false, true);
					num71++;
				}
				int num72 = 0;
				while ((float)num72 <= 10f * num59)
				{
					...
					num60 = num67 + WorldMod.genRand.Next((int)(-600f * num59), (int)(600f * num59));
					num62 = num68 + WorldMod.genRand.Next((int)(-200f * num59), (int)(200f * num59));
					...
					{
						num60 += WorldMod.genRand.Next(-30, 31);
						num62 += WorldMod.genRand.Next(-30, 31);
						int type4 = -1;
						if (WorldMod.genRand.Next(7) == 0)
						{
							type4 = -2;
						}
						TileRunner(num60, num62, (double)WorldMod.genRand.Next(10, 20), WorldMod.genRand.Next(30, 70), type4, false, 0f, 0f, false, true);
						num73++;
					}
					num72++;
				}
				...
				while ((float)num74 <= 300f * num59)
				{
					...
					TileRunner(num60, num62, (double)WorldMod.genRand.Next(4, 10), WorldMod.genRand.Next(5, 30), 1, false, 0f, 0f, false, true);
					if (WorldMod.genRand.Next(4) == 0)
					{
						int type5 = WorldMod.genRand.Next(63, 69);
						TileRunner(num60 + WorldMod.genRand.Next(-1, 2), num62 + WorldMod.genRand.Next(-1, 2), (double)WorldMod.genRand.Next(3, 7), WorldMod.genRand.Next(4, 8), type5, false, 0f, 0f, false, true);
					}
					num74++;
				}
				num60 = num67;
				num62 = num68;
				float num75 = (float)WorldMod.genRand.Next(6, 10);
				...
				while ((float)num77 < num75)
				{
					...
					while (flag4)
					{
						num60 = WorldMod.genRand.Next(20, Main.maxTilesX - 20);
						num62 = WorldMod.genRand.Next((int)(Main.worldSurface + Main.rockLayer) / 2, Main.maxTilesY - 300);
						if (Main.tile.At(num60, num62).Type == 59)
						{
							flag4 = false;
							int num78 = WorldMod.genRand.Next(2, 4);
							int num79 = WorldMod.genRand.Next(2, 4);
							...
							{
								num84++;
								int num85 = WorldMod.genRand.Next(num60 - num78, num60 + num78 + 1);
								int num86 = WorldMod.genRand.Next(num62 - num79, num62 + num79 - 2);
								WorldMod.PlaceTile(num85, num86, 4, true, false, -1, 0);
							...
							num78 -= WorldMod.genRand.Next(1, 3);
				...
				for (int num96 = 0; num96 < Main.maxTilesX; num96++)
				{
					for (int num97 = 0; num97 < Main.maxTilesY; num97++)
					{
						...
						{
							WorldMod.SpreadGrass(num96, num97, 59, 60, true);
						}
					}
				}
			}
			...
			for (int num98 = 0; num98 < WorldMod.ficount; num98++)
			{
				int num99 = 0;
				bool flag6 = false;
				int num100 = WorldMod.genRand.Next((int)((double)Main.maxTilesX * 0.1), (int)((double)Main.maxTilesX * 0.9));
				bool flag7 = false;
				while (!flag7)
				{
					flag7 = true;
					...
					{
						num100 = WorldMod.genRand.Next((int)((double)Main.maxTilesX * 0.1), (int)((double)Main.maxTilesX * 0.9));
					}
				...
				if (!flag6)
				{
					...
					while ((double)num102 < Main.worldSurface)
					{
						...
						{
							int num103 = num100;
							int num104 = WorldMod.genRand.Next(90, num102 - 100);
			...
			{
				int i2 = WorldMod.genRand.Next((int)((double)Main.maxTilesX * 0.3), (int)((double)Main.maxTilesX * 0.7));
				int j2 = WorldMod.genRand.Next((int)Main.rockLayer, Main.maxTilesY - 300);
				ShroomPatch(i2, j2);
			}
			for (int num106 = 0; num106 < Main.maxTilesX; num106++)
			{
				for (int num107 = (int)Main.worldSurface; num107 < Main.maxTilesY; num107++)
				{
					...
					{
						WorldMod.SpreadGrass(num106, num107, 59, 70, false);
					}
				}
			}
			...
			{
				TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num7, Main.maxTilesY), (double)WorldMod.genRand.Next(2, 6), WorldMod.genRand.Next(2, 40), 59, false, 0f, 0f, false, true);
			}
			...
			{ // shinies
					...
					+ num114max + num115max + num116max + num117max + num118max + num119max + num120max - 12, "Adding shinies"))
				{
					...
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num5, (int)num6), (double)WorldMod.genRand.Next(3, 6), WorldMod.genRand.Next(2, 6), 7, false, 0f, 0f, false, true);
					}
					for (int num110 = 0; num110 < num110max; num110++)
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num6, (int)num8), (double)WorldMod.genRand.Next(3, 7), WorldMod.genRand.Next(3, 7), 7, false, 0f, 0f, false, true);
					}
					for (int num111 = 0; num111 < num111max; num111++)
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num7, Main.maxTilesY), (double)WorldMod.genRand.Next(4, 9), WorldMod.genRand.Next(4, 8), 7, false, 0f, 0f, false, true);
					}
					for (int num112 = 0; num112 < num112max; num112++)
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num5, (int)num6), (double)WorldMod.genRand.Next(3, 7), WorldMod.genRand.Next(2, 5), 6, false, 0f, 0f, false, true);
					}
					for (int num113 = 0; num113 < num113max; num113++)
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num6, (int)num8), (double)WorldMod.genRand.Next(3, 6), WorldMod.genRand.Next(3, 6), 6, false, 0f, 0f, false, true);
					}
					for (int num114 = 0; num114 < num114max; num114++)
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num7, Main.maxTilesY), (double)WorldMod.genRand.Next(4, 9), WorldMod.genRand.Next(4, 8), 6, false, 0f, 0f, false, true);
					}
					for (int num115 = 0; num115 < num115max; num115++)
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num6, (int)num8), (double)WorldMod.genRand.Next(3, 6), WorldMod.genRand.Next(3, 6), 9, false, 0f, 0f, false, true);
					}
					for (int num116 = 0; num116 < num116max; num116++)
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num7, Main.maxTilesY), (double)WorldMod.genRand.Next(4, 9), WorldMod.genRand.Next(4, 8), 9, false, 0f, 0f, false, true);
					}
					for (int num117 = 0; num117 < num117max; num117++)
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next(0, (int)num5), (double)WorldMod.genRand.Next(4, 9), WorldMod.genRand.Next(4, 8), 9, false, 0f, 0f, false, true);
					}
					for (int num118 = 0; num118 < num118max; num118++)
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num7, Main.maxTilesY), (double)WorldMod.genRand.Next(4, 8), WorldMod.genRand.Next(4, 8), 8, false, 0f, 0f, false, true);
					}
					for (int num119 = 0; num119 < num119max; num119++)
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next(0, (int)num5 - 20), (double)WorldMod.genRand.Next(4, 8), WorldMod.genRand.Next(4, 8), 8, false, 0f, 0f, false, true);
					}
					for (int num120 = 0; num120 < num120max; num120++)
					{
						prog.Value = total++;
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next((int)num7, Main.maxTilesY), (double)WorldMod.genRand.Next(2, 4), WorldMod.genRand.Next(3, 6), 22, false, 0f, 0f, false, true);
					}
				}
			}
			...
			{
				int num122 = WorldMod.genRand.Next(20, Main.maxTilesX - 20);
				int num123 = WorldMod.genRand.Next((int)num5, Main.maxTilesY - 20);
				if (num121 < numMCaves)
				{
				...
				if (!Main.tile.At(num122, num123).Active)
				{
					...
					{
						TileRunner(num122, num123, (double)WorldMod.genRand.Next(4, 13), WorldMod.genRand.Next(2, 5), 51, true, (float)num124, -1f, false, false);
					}
				}
			}
			...
			{
				var uwtotal = 0;
				int num125 = Main.maxTilesY - WorldMod.genRand.Next(150, 190);
				for (int num126 = 0; num126 < Main.maxTilesX; num126++)
				{
					uwprog.Value = (uwtotal++);
					num125 += WorldMod.genRand.Next(-3, 4);
					...
					for (int num127 = num125 - 20 - WorldMod.genRand.Next(3); num127 < Main.maxTilesY; num127++)
					{
						if (num127 >= num125)
						{
				...
				int num128 = Main.maxTilesY - WorldMod.genRand.Next(40, 70);
				for (int num129 = 10; num129 < Main.maxTilesX - 10; num129++)
				{
					uwprog.Value = (uwtotal++);
					num128 += WorldMod.genRand.Next(-10, 11);
				...
				for (int num131 = 0; num131 < Main.maxTilesX; num131++)
				{
					...
					if (WorldMod.genRand.Next(50) == 0)
					{
						...
						TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), num132 + WorldMod.genRand.Next(20, 50), (double)WorldMod.genRand.Next(15, 20), 1000, 57, true, 0f, (float)WorldMod.genRand.Next(1, 3), true, true);
					}
				}
				...
				for (int num133 = 0; num133 < Main.maxTilesX; num133++)
				{
					...
					if (WorldMod.genRand.Next(13) == 0)
					{
						...
						TileRunner(num133, num135 - WorldMod.genRand.Next(2, 5), (double)WorldMod.genRand.Next(5, 30), 1000, 57, true, 0f, (float)WorldMod.genRand.Next(1, 3), true, true);
						float num136 = (float)WorldMod.genRand.Next(1, 3);
						if (WorldMod.genRand.Next(3) == 0)
						{
							num136 *= 0.5f;
						}
						if (WorldMod.genRand.Next(2) == 0)
						{
							TileRunner(num133, num135 - WorldMod.genRand.Next(2, 5), (double)((int)((float)WorldMod.genRand.Next(5, 15) * num136)), (int)((float)WorldMod.genRand.Next(10, 15) * num136), 57, true, 1f, 0.3f, false, true);
						}
						if (WorldMod.genRand.Next(2) == 0)
						{
							num136 = (float)WorldMod.genRand.Next(1, 3);
							TileRunner(num133, num135 - WorldMod.genRand.Next(2, 5), (double)((int)((float)WorldMod.genRand.Next(5, 15) * num136)), (int)((float)WorldMod.genRand.Next(10, 15) * num136), 57, true, -1f, 0.3f, false, true);
						}
						TileRunner(num133 + WorldMod.genRand.Next(-10, 10), num135 + WorldMod.genRand.Next(-10, 10), (double)WorldMod.genRand.Next(5, 15), WorldMod.genRand.Next(5, 10), -2, false, (float)WorldMod.genRand.Next(-1, 3), (float)WorldMod.genRand.Next(-1, 3), false, true);
						if (WorldMod.genRand.Next(3) == 0)
						{
							TileRunner(num133 + WorldMod.genRand.Next(-10, 10), num135 + WorldMod.genRand.Next(-10, 10), (double)WorldMod.genRand.Next(10, 30), WorldMod.genRand.Next(10, 20), -2, false, (float)WorldMod.genRand.Next(-1, 3), (float)WorldMod.genRand.Next(-1, 3), false, true);
						}
						if (WorldMod.genRand.Next(5) == 0)
						{
							TileRunner(num133 + WorldMod.genRand.Next(-15, 15), num135 + WorldMod.genRand.Next(-15, 10), (double)WorldMod.genRand.Next(15, 30), WorldMod.genRand.Next(5, 20), -2, false, (float)WorldMod.genRand.Next(-1, 3), (float)WorldMod.genRand.Next(-1, 3), false, true);
						}
					}
				}
				...
				{
					uwprog.Value = (uwtotal++);
					TileRunner(WorldMod.genRand.Next(0, Main.maxTilesX), WorldMod.genRand.Next(Main.maxTilesY - 140, Main.maxTilesY), (double)WorldMod.genRand.Next(3, 8), WorldMod.genRand.Next(3, 8), 58, false, 0f, 0f, false, true);
				}
			}

			AddHellHouses();
			int num139 = WorldMod.genRand.Next(2, (int)((double)Main.maxTilesX * 0.005));
			...
			using (var prog = new ProgressLogger(num139 - 1, "Adding water bodies"))
				for (int num140 = 0; num140 < num139; num140++)
				{
					...
					int num142 = WorldMod.genRand.Next(300, Main.maxTilesX - 300);
					while (num142 > Main.maxTilesX / 2 - 50 && num142 < Main.maxTilesX / 2 + 50)
					{
						num142 = WorldMod.genRand.Next(300, Main.maxTilesX - 300);
					}
			...
			int x = WorldMod.genRand.Next((int)((double)Main.maxTilesX * 0.05), (int)((double)Main.maxTilesX * 0.2)); //Left?
			int x2 = WorldMod.genRand.Next((int)((double)Main.maxTilesX * 0.8), (int)((double)Main.maxTilesX * 0.95)); //Right?
			int y = 0;
			...
			{
				y = (int)((Main.rockLayer + (double)Main.maxTilesY) / 2.0) + WorldMod.genRand.Next(-200, 200); //Generate a custon Y each time
				if (dnum == 1)
				{
					//num9 = direction
			...
			using (var prog = new ProgressLogger(100, "Making the world evil"))
			{
				while ((double)num144 < (double)Main.maxTilesX * 0.00045)
				{
					...
					while (!flag8)
					{
						...
						int num151 = 200;
						num146 = WorldMod.genRand.Next(320, Main.maxTilesX - 320);
						num147 = num146 - WorldMod.genRand.Next(200) - 100;
						num148 = num146 + WorldMod.genRand.Next(200) + 100;
						if (num147 < 285)
						{
							num147 = 285;
						}
					...
					for (int num155 = num147; num155 < num148; num155++)
					{
						...
						if (num155 == num146 || num154 == 0)
						{
							...
							while ((double)num156 < Main.worldSurface - 1.0)
							{
								if (Main.tile.At(num155, num156).Active || Main.tile.At(num155, num156).Wall > 0)
								{
									...
									{
										num154 = 20;
										ChasmRunner(num155, num156, WorldMod.genRand.Next(150) + 150, true);
										break;
									}
									if (WorldMod.genRand.Next(35) == 0 && num154 == 0)
									{
										num154 = 30;
										bool makeOrb = true;
										ChasmRunner(num155, num156, WorldMod.genRand.Next(50) + 50, makeOrb);
										break;
									}
									break;
								}
						...
						while ((double)num157 < Main.worldSurface - 1.0)
						{
							...
							{
								int num158 = num157 + WorldMod.genRand.Next(10, 14);
								for (int num159 = num157; num159 < num158; num159++)
								{
									if ((Main.tile.At(num155, num159).Type == 59 || Main.tile.At(num155, num159).Type == 60) && num155 >= num147 + WorldMod.genRand.Next(5) && num155 < num148 - WorldMod.genRand.Next(5))
									{
					...
					{
						num160 += (double)WorldMod.genRand.Next(-2, 3);
						...
						while ((double)num162 < num160)
						{
							...
							{
								if (Main.tile.At(num48, num162).Type == 53 && num48 >= num147 + WorldMod.genRand.Next(5) && num48 <= num148 - WorldMod.genRand.Next(5))
								{
									Main.tile.At(num48, num162).SetType(0);
								}
								if (Main.tile.At(num48, num162).Type == 0 && (double)num162 < Main.worldSurface - 1.0 && !flag9)
								{
									WorldMod.SpreadGrass(num48, num162, 0, 23, true);
								}
								flag9 = true;
								if (Main.tile.At(num48, num162).Type == 1 && num48 >= num147 + WorldMod.genRand.Next(5) && num48 <= num148 - WorldMod.genRand.Next(5))
								{
							...
							if (Main.tile.At(num163, num164).Active && Main.tile.At(num163, num164).Type == 31)
							{
								...
								for (int num169 = num165; num169 < num166; num169++)
								{
									if (num169 > 10 && num169 < Main.maxTilesX - 10)
									{
										...
										{
											if (Math.Abs(num169 - num163) + Math.Abs(num170 - num164) < 9 + WorldMod.genRand.Next(11) && WorldMod.genRand.Next(3) != 0 && Main.tile.At(num169, num170).Type != 31)
											{
											...
											if (Main.tile.At(num169, num170).Type != 31 && Math.Abs(num169 - num163) <= 2 + WorldMod.genRand.Next(3) && Math.Abs(num170 - num164) <= 2 + WorldMod.genRand.Next(3))
											{
												Main.tile.At(num169, num170).SetActive(false);
											}
										}
			...
			for (int num171 = 0; num171 < numMCaves; num171++)
			{
				...
				CaveOpenater(i3, j3);
				Cavinator(i3, j3, WorldMod.genRand.Next(40, 50));
			}
			int num172 = 0;
			int num173 = 0;
			int num174 = 20;
			...
			for (int num176 = 0; num176 < 2; num176++)
			{
				...
				{
					num177 = 0;
					num178 = WorldMod.genRand.Next(125, 200) + 50;
					if (num9 == 1)
					{
						num178 = 275;
					}
					...
					num172 = num181;
					num181 += WorldMod.genRand.Next(1, 5);
					for (int num182 = num178 - 1; num182 >= num177; num182--)
					{
						num179++;
						if (num179 < 3)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.2f;
						}
						else if (num179 < 6)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.15f;
						}
						else if (num179 < 9)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.1f;
						}
						else if (num179 < 15)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.07f;
						}
						else if (num179 < 50)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.05f;
						}
						else if (num179 < 75)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.04f;
						}
						else if (num179 < 100)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.03f;
						}
						else if (num179 < 125)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.02f;
						}
						else if (num179 < 150)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.01f;
						}
						else if (num179 < 175)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.005f;
						}
						else if (num179 < 200)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.001f;
						}
						else if (num179 < 230)
						{
							num180 += (float)WorldMod.genRand.Next(10, 20) * 0.01f;
						...
						int num183 = WorldMod.genRand.Next(15, 20);
						int num184 = 0;
				...
				{
					num177 = Main.maxTilesX - WorldMod.genRand.Next(125, 200) - 50;
					...
					num173 = num187;
					num187 += WorldMod.genRand.Next(1, 5);
					for (int num188 = num177; num188 < num178; num188++)
					{
						num186++;
						if (num186 < 3)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.2f;
						}
						else if (num186 < 6)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.15f;
						}
						else if (num186 < 9)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.1f;
						}
						else if (num186 < 15)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.07f;
						}
						else if (num186 < 50)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.05f;
						}
						else if (num186 < 75)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.04f;
						}
						else if (num186 < 100)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.03f;
						}
						else if (num186 < 125)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.02f;
						}
						else if (num186 < 150)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.01f;
						}
						else if (num186 < 175)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.005f;
						}
						else if (num186 < 200)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.001f;
						}
						else if (num186 < 230)
						{
							num185 += (float)WorldMod.genRand.Next(10, 20) * 0.01f;
						...
						int num189 = WorldMod.genRand.Next(15, 20);
						int num190 = 0;
			...
			for (int num191 = 63; num191 <= 68; num191++)
			{
				...
				{
					int num194 = WorldMod.genRand.Next(0, Main.maxTilesX);
					int num195 = WorldMod.genRand.Next((int)Main.worldSurface, Main.maxTilesY);
					while (Main.tile.At(num194, num195).Type != 1)
					{
						num194 = WorldMod.genRand.Next(0, Main.maxTilesX);
						num195 = WorldMod.genRand.Next((int)Main.worldSurface, Main.maxTilesY);
					}
					TileRunner(num194, num195, (double)WorldMod.genRand.Next(2, 6), WorldMod.genRand.Next(3, 7), num191, false, 0f, 0f, false, true);
					num193++;
				}
			} // end gems
					...
					while ((double)num202 < Main.worldSurface)
					{
						if (flag10)
						{
							...
							if (Main.tile.At(num200, num202).Type != 53)
							{
								...
								if (Main.tile.At(num200 - 2, num202).Wall == 2 && WorldMod.genRand.Next(2) == 0)
								{
									Main.tile.At(num200 - 2, num202).SetWall(0);
								}
								if (Main.tile.At(num200 - 3, num202).Wall == 2 && WorldMod.genRand.Next(2) == 0)
								{
			...
			using (var prog = new ProgressLogger(num203max - 1, "Placing altars"))
				for (int num203 = 0; num203 < num203max; num203++)
				{
					...
					while (!flag11)
					{
						int num206 = WorldMod.genRand.Next(1, Main.maxTilesX);
						int num207 = (int)(num6 + 20.0);
						WorldMod.Place3x2(num206, num207, 26);
			...
			using (var prog = new ProgressLogger(num218max - 1, "Placing life crystals"))
				for (int num218 = 0; num218 < num218max; num218++)
				{
					...
					while (!flag12)
					{
						if (AddLifeCrystal(WorldMod.genRand.Next(1, Main.maxTilesX), WorldMod.genRand.Next((int)(num6 + 20.0), Main.maxTilesY)))
						{
							flag12 = true;
						}
						else
			...
			using (var prog = new ProgressLogger(num221max - 1, "Hiding treasure"))
				for (int num221 = 0; num221 < num221max; num221++)
				{
					...
					while (!flag13)
					{
						int num224 = WorldMod.genRand.Next(20, Main.maxTilesX - 20);
						int num225 = WorldMod.genRand.Next((int)(num6 + 20.0), Main.maxTilesY - 20);
						while (Main.tile.At(num224, num225).Wall > 0)
						{
							num224 = WorldMod.genRand.Next(1, Main.maxTilesX);
							num225 = WorldMod.genRand.Next((int)(num6 + 20.0), Main.maxTilesY - 20);
						}
			...
			using (var prog = new ProgressLogger(num226max - 1, "Hiding more treasure"))
				for (int num226 = 0; num226 < num226max; num226++)
				{
					...
					while (!flag14)
					{
						int num229 = WorldMod.genRand.Next(300, Main.maxTilesX - 300);
						int num230 = WorldMod.genRand.Next((int)num5, (int)Main.worldSurface);
						bool flag15 = false;
			...
			for (int num232 = 0; num232 < numJChests; num232++)
			{
				...
				if (!AddBuriedChest(JChestX[num232] + WorldMod.genRand.Next(2), JChestY[num232], contain, false))
				{
					for (int num233 = JChestX[num232]; num233 <= JChestX[num232] + 1; num233++)
					{
						for (int num234 = JChestY[num232]; num234 <= JChestY[num232] + 1; num234++)
						{
							WorldMod.KillTile(num233, num234, false, false, false);
						}
					}
			...
			while ((float)num237 < 10f * num235)
			{
				...
				while (!flag16)
				{
					int num238 = WorldMod.genRand.Next(1, Main.maxTilesX);
					int num239 = WorldMod.genRand.Next(1, Main.maxTilesY - 200);
					while (Main.tile.At(num238, num239).Liquid < 200 || Main.tile.At(num238, num239).Lava)
					{
						num238 = WorldMod.genRand.Next(1, Main.maxTilesX);
						num239 = WorldMod.genRand.Next(1, Main.maxTilesY - 200);
					}
			...
			using (var prog = new ProgressLogger(num241max - 1, "Placing breakables"))
			{
				for (int num241 = 0; num241 < num241max; num241++)
				{
					...
					while (!flag17)
					{
						int num244 = WorldMod.genRand.Next((int)num6, Main.maxTilesY - 10);
						...
						int num245 = WorldMod.genRand.Next(1, Main.maxTilesX);
						bool flag18 = false;
						for (int num246 = num244; num246 < Main.maxTilesY; num246++)
						{
							...
							{
								if (WorldMod.PlacePot(num245, num246, 28))
								{
									flag17 = true;
									break;
								}
			...
			using (var prog = new ProgressLogger(num247max - 1, "Placing hellforges"))
			{
				for (int num247 = 0; num247 < num247max; num247++)
				{
					...
					while (!flag19)
					{
						int num250 = WorldMod.genRand.Next(1, Main.maxTilesX);
						int num251 = WorldMod.genRand.Next(Main.maxTilesY - 250, Main.maxTilesY - 5);
						try
						{
							if (Main.tile.At(num250, num251).Wall == 13)
							{
								...
								num251--;
								WorldMod.PlaceTile(num250, num251, 77, false, false, -1, 0);
			...
			for (int num252 = 0; num252 < Main.maxTilesX; num252++)
			{
				...
				while ((double)num253 < Main.worldSurface - 1.0)
				{
					if (Main.tile.At(num48, num253).Active)
					{
						...
						{
							WorldMod.SpreadGrass(num48, num253, 0, 2, true);
						}
					...
					while ((double)num255 < Main.worldSurface - 1.0)
					{
						if (Main.tile.At(num254, num255).Active && Main.tile.At(num254, num255).Type == 53 && !Main.tile.At(num254, num255 - 1).Active && Main.tile.At(num254, num255 - 1).Wall == 0)
						{
							if (num254 < 250 || num254 > Main.maxTilesX - 250)
							{
								...
								{
									WorldMod.PlaceTile(num254, num255 - 1, 81, true, false, -1, 0);
								}
							}
							else if (num254 > 400 && num254 < Main.maxTilesX - 400)
							{
								WorldMod.PlantCactus(num254, num255);
							}
						}
						num255++;
					}
			...
			while (flag21)
			{
				int num257 = Main.maxTilesX / 2 + WorldMod.genRand.Next(-num256, num256 + 1);
			...
			{
				int num260 = WorldMod.genRand.Next(Main.maxTilesX / 2 - num259, Main.maxTilesX / 2 + num259);
			...
			while ((double)num263 < (double)Main.maxTilesX * 0.002)
			{
				...
				int num266 = WorldMod.genRand.Next(Main.maxTilesX);
				num264 = num266 - WorldMod.genRand.Next(10) - 7;
				num265 = num266 + WorldMod.genRand.Next(10) + 7;
				if (num264 < 0)
				{
					num264 = 0;
				}
				...
				for (int num267 = num264; num267 < num265; num267++)
				{
					...
					while ((double)num268 < Main.worldSurface - 1.0)
					{
						...
						{
							WorldMod.PlaceTile(num267, num268 - 1, 27, true, false, -1, 0);
						}
			...
			{
				int num270 = WorldMod.genRand.Next(50, Main.maxTilesX - 50);
				int num271 = WorldMod.genRand.Next(25, 50);
			...
			for (int num275 = 0; num275 < Main.maxTilesX; num275++)
			{
				for (int num276 = 0; num276 < Main.maxTilesY; num276++)
				{
					if (Main.tile.At(num275, num276).Active)
					{
						...
						{
							WorldMod.GrowShroom(num275, num276);
							if (!Main.tile.At(num275, num276 - 1).Active)
							{
								WorldMod.PlaceTile(num275, num276 - 1, 71, true, false, -1, 0);
							}
						}
						if (Main.tile.At(num275, num276).Type == 60 && !Main.tile.At(num275, num276 - 1).Active)
						{
							WorldMod.PlaceTile(num275, num276 - 1, 61, true, false, -1, 0);
						}
					}
				}
			}
			...
			for (int num277 = 0; num277 < Main.maxTilesX; num277++)
			{
				...
				while ((double)num279 < Main.worldSurface)
				{
					...
					if (Main.tile.At(num277, num279).Active && Main.tile.At(num277, num279).Type == 2 && WorldMod.genRand.Next(5) < 3)
					{
						num278 = WorldMod.genRand.Next(1, 10);
					}
					num279++;
				}
				num278 = 0;
				for (int num280 = 0; num280 < Main.maxTilesY; num280++)
				{
					...
					if (Main.tile.At(num277, num280).Active && Main.tile.At(num277, num280).Type == 60 && WorldMod.genRand.Next(5) < 3)
					{
						num278 = WorldMod.genRand.Next(1, 10);
					}
				}
			...
			{
				int num282 = WorldMod.genRand.Next(20, Main.maxTilesX - 20);
				int num283 = WorldMod.genRand.Next(5, 15);
				int num284 = WorldMod.genRand.Next(15, 30);
				int num285 = 1;
					...
					if (Main.tile.At(num282, num285).Active)
					{
						for (int num286 = num282 - num283; num286 < num282 + num283; num286++)
						{
							for (int num287 = num285 - num284; num287 < num285 + num284; num287++)
							{
								...
								{
									Main.tile.At(num286, num287).SetFrameX((short)(WorldMod.genRand.Next(6, 8) * 18));
								}
							}
						}
						break;
			...
			{
				int num289 = WorldMod.genRand.Next(20, Main.maxTilesX - 20);
				int num290 = WorldMod.genRand.Next(4, 10);
				int num291 = WorldMod.genRand.Next(15, 30);
				int num292 = 1;
		...
		public static bool AddBuriedChest(int i, int j, int contain = 0, bool notNearOtherChests = false)
		{
			...
			while (k < Main.maxTilesY)
			{
				if (Main.tile.At(i, k).Active && Main.tileSolid[(int)Main.tile.At(i, k).Type])
				{
					...
					int num2 = WorldMod.PlaceChest(i - 1, num - 1, 21, notNearOtherChests, style);
					if (num2 >= 0)
					{
						int num3 = 0;
						while (num3 == 0)
						{
							if ((double)num < Main.worldSurface + 25.0)
							{
								...
								{
									int num4 = WorldMod.genRand.Next(6);
									if (num4 == 0)
									{
									...
									if (num4 == 3)
									{
										...
										Main.chest[num2].contents[num3].Stack = WorldMod.genRand.Next(50, 75);
									}
									if (num4 == 4)
									{
										Main.chest[num2].contents[num3] = Registries.Item.Create(279);
										Main.chest[num2].contents[num3].Stack = WorldMod.genRand.Next(25, 50);
									}
									if (num4 == 5)
									{
								...
								if (WorldMod.genRand.Next(3) == 0)
								{
									...
									Main.chest[num2].contents[num3].Stack = WorldMod.genRand.Next(3, 6);
									num3++;
								}
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num5 = WorldMod.genRand.Next(2);
									int stack = WorldMod.genRand.Next(8) + 3;
									if (num5 == 0)
									{
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num6 = WorldMod.genRand.Next(2);
									int stack2 = WorldMod.genRand.Next(26) + 25;
									if (num6 == 0)
									{
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num7 = WorldMod.genRand.Next(1);
									int stack3 = WorldMod.genRand.Next(3) + 3;
									if (num7 == 0)
									{
								...
								if (WorldMod.genRand.Next(3) > 0)
								{
									int num8 = WorldMod.genRand.Next(4);
									int stack4 = WorldMod.genRand.Next(1, 3);
									if (num8 == 0)
									{
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num9 = WorldMod.genRand.Next(2);
									int stack5 = WorldMod.genRand.Next(11) + 10;
									if (num9 == 0)
									{
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									...
									Main.chest[num2].contents[num3].Stack = WorldMod.genRand.Next(10, 30);
									num3++;
								}
							}
							else if ((double)num < Main.rockLayer)
							{
								...
								{
									int num10 = WorldMod.genRand.Next(7);
									if (num10 == 0)
									{
									...
									if (num10 == 6)
									{
										...
										Main.chest[num2].contents[num3].Stack = WorldMod.genRand.Next(26) + 25;
									}
									num3++;
								}
								if (WorldMod.genRand.Next(3) == 0)
								{
									...
									Main.chest[num2].contents[num3].Stack = WorldMod.genRand.Next(10, 20);
									num3++;
								}
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num11 = WorldMod.genRand.Next(2);
									int stack6 = WorldMod.genRand.Next(10) + 5;
									if (num11 == 0)
									{
										Main.chest[num2].contents[num3] = Registries.Item.Create(22);
									}
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num12 = WorldMod.genRand.Next(2);
									int stack7 = WorldMod.genRand.Next(25) + 25;
									if (num12 == 0)
									{
										Main.chest[num2].contents[num3] = Registries.Item.Create(40);
									}
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num13 = WorldMod.genRand.Next(1);
									int stack8 = WorldMod.genRand.Next(3) + 3;
									if (num13 == 0)
									{
										Main.chest[num2].contents[num3] = Registries.Item.Create(28);
									}
								...
								if (WorldMod.genRand.Next(3) > 0)
								{
									int num14 = WorldMod.genRand.Next(7);
									int stack9 = WorldMod.genRand.Next(1, 3);
									if (num14 == 0)
									{
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int stack10 = WorldMod.genRand.Next(11) + 10;
									Main.chest[num2].contents[num3] = Registries.Item.Create(8);
								...
								{
									Main.chest[num2].contents[num3] = Registries.Item.Create(72);
									Main.chest[num2].contents[num3].Stack = WorldMod.genRand.Next(50, 90);
									num3++;
								}
							}
							else if (num < Main.maxTilesY - 250)
							{
								...
								{
									int num15 = WorldMod.genRand.Next(7);
									if (num15 == 2 && WorldMod.genRand.Next(2) == 0)
									{
										num15 = WorldMod.genRand.Next(7);
									}
									if (num15 == 0)
									{
										Main.chest[num2].contents[num3] = Registries.Item.Create(49);
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num16 = WorldMod.genRand.Next(2);
									int stack11 = WorldMod.genRand.Next(8) + 3;
									if (num16 == 0)
									{
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num17 = WorldMod.genRand.Next(2);
									int stack12 = WorldMod.genRand.Next(26) + 25;
									if (num17 == 0)
									{
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num18 = WorldMod.genRand.Next(1);
									int stack13 = WorldMod.genRand.Next(3) + 3;
									if (num18 == 0)
									{
								...
								if (WorldMod.genRand.Next(3) > 0)
								{
									int num19 = WorldMod.genRand.Next(6);
									int stack14 = WorldMod.genRand.Next(1, 3);
									if (num19 == 0)
									{
								...
								if (WorldMod.genRand.Next(3) > 1)
								{
									int num20 = WorldMod.genRand.Next(4);
									int stack15 = WorldMod.genRand.Next(1, 3);
									if (num20 == 0)
									{
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num21 = WorldMod.genRand.Next(2);
									int stack16 = WorldMod.genRand.Next(15) + 15;
									if (num21 == 0)
									{
										Main.chest[num2].contents[num3] = Registries.Item.Create(8);
									}
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									...
									Main.chest[num2].contents[num3].Stack = WorldMod.genRand.Next(1, 3);
									num3++;
								}
							}
							else
							{
								...
								else
								{
									...
									{
										int num22 = WorldMod.genRand.Next(4);
										if (num22 == 0)
										{
											Main.chest[num2].contents[num3] = Registries.Item.Create(49);
										}
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num23 = WorldMod.genRand.Next(2);
									int stack17 = WorldMod.genRand.Next(15) + 15;
									if (num23 == 0)
									{
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num24 = WorldMod.genRand.Next(2);
									int stack18 = WorldMod.genRand.Next(25) + 50;
									if (num24 == 0)
									{
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num25 = WorldMod.genRand.Next(2);
									int stack19 = WorldMod.genRand.Next(15) + 15;
									if (num25 == 0)
									{
								...
								if (WorldMod.genRand.Next(4) > 0)
								{
									int num26 = WorldMod.genRand.Next(7);
									int stack20 = WorldMod.genRand.Next(1, 3);
									if (num26 == 0)
									{
										Main.chest[num2].contents[num3] = Registries.Item.Create(296);
									}
								...
								if (WorldMod.genRand.Next(3) > 0)
								{
									int num27 = WorldMod.genRand.Next(5);
									int stack21 = WorldMod.genRand.Next(1, 3);
									if (num27 == 0)
									{
										Main.chest[num2].contents[num3] = Registries.Item.Create(305);
									}
								...
								if (WorldMod.genRand.Next(2) == 0)
								{
									int num28 = WorldMod.genRand.Next(2);
									int stack22 = WorldMod.genRand.Next(15) + 15;
									if (num28 == 0)
									{
										Main.chest[num2].contents[num3] = Registries.Item.Create(8);
									}
								...
								{
									Main.chest[num2].contents[num3] = Registries.Item.Create(73);
									Main.chest[num2].contents[num3].Stack = WorldMod.genRand.Next(2, 5);
									num3++;
								}
							}
						}
		...
		public static void MakeDungeon(int x, int y, int tileType = 41, int wallType = 7)
		{
			...
			{
				int num = WorldMod.genRand.Next(3);
				int num2 = WorldMod.genRand.Next(3);
				if (num == 1)
				{
					tileType = 43;
				}
				...
				dMinY = y;
				dMaxY = y;
				dxStrength1 = (double)WorldMod.genRand.Next(25, 30);
				dyStrength1 = (double)WorldMod.genRand.Next(20, 25);
				dxStrength2 = (double)WorldMod.genRand.Next(35, 50);
				dyStrength2 = (double)WorldMod.genRand.Next(10, 15);
				float num3 = (float)(Main.maxTilesX / 60);
				num3 += (float)WorldMod.genRand.Next(0, (int)(num3 / 3f));
				float num4 = num3;
				int num5 = 5;
				...
				while (num3 > 0f)
				{
					...
					if (num5 == 0 & WorldMod.genRand.Next(3) == 0)
					{
						num5 = 5;
						if (WorldMod.genRand.Next(2) == 0)
						{
				...
				while (!dSurface)
				{
					...
					if ((num5 == 0 & WorldMod.genRand.Next(5) == 0) && (double)dungeonY > Main.worldSurface + 50.0)
					{
						num5 = 10;
						int num10 = dungeonX;
						int num11 = dungeonY;
				...
				{
					num12++;
					int num15 = WorldMod.genRand.Next(dMinX, dMaxX);
					int num16 = WorldMod.genRand.Next((int)Main.worldSurface + 25, dMaxY);
					int num17 = num15;
					if ((int)Main.tile.At(num15, num16).Wall == wallType && !Main.tile.At(num15, num16).Active)
					{
						...
						{
							num14++;
							int num19 = WorldMod.genRand.Next(5, 13);
							...
							num19 = WorldMod.genRand.Next(5, 13);
							num15 = num17 + 1;
							while (Main.tile.At(num15 + 1, num16).Active && Main.tile.At(num15, num16 + num18).Active && Main.tile.At(num15, num16).Active && !Main.tile.At(num15, num16 - num18).Active && num19 > 0)
							{
								Main.tile.At(num15, num16).SetType(48);
				...
				{
					num12++;
					int num20 = WorldMod.genRand.Next(dMinX, dMaxX);
					int num21 = WorldMod.genRand.Next((int)Main.worldSurface + 25, dMaxY);
					int num22 = num21;
					if ((int)Main.tile.At(num20, num21).Wall == wallType && !Main.tile.At(num20, num21).Active)
					{
						...
						{
							num14++;
							int num24 = WorldMod.genRand.Next(5, 13);
							...
							num24 = WorldMod.genRand.Next(5, 13);
							num21 = num22 + 1;
							while (Main.tile.At(num20, num21 + 1).Active && Main.tile.At(num20 + num23, num21).Active && Main.tile.At(num20, num21).Active && !Main.tile.At(num20 - num23, num21).Active && num24 > 0)
							{
								Main.tile.At(num20, num21).SetType(48);
				...
				for (int num25 = 0; num25 < numDDoors; num25++)
				{
					...
					if (num28 < 20)
					{
						...
						WorldMod.PlaceTile(num42, num43, 10, true, false, -1, 0);
						num42--;
						int num46 = num43 - 3;
						...
						{
							for (int num47 = num43 - 4 - WorldMod.genRand.Next(3); num47 > num46; num47--)
							{
						...
						if (num43 - num46 < num43 - num44 + 5 && Main.tileDungeon[(int)Main.tile.At(num42, num46).Type])
						{
							for (int num48 = num43 - 4 - WorldMod.genRand.Next(3); num48 > num46; num48--)
							{
				...
				{
					num12++;
					int num67 = WorldMod.genRand.Next(dMinX, dMaxX);
					int num68 = WorldMod.genRand.Next(dMinY, dMaxY);
					bool flag5 = true;
					if ((int)Main.tile.At(num67, num68).Wall == wallType && !Main.tile.At(num67, num68).Active)
					{
						...
						if (flag5 && Main.tile.At(num67, num68).Active && Main.tileDungeon[(int)Main.tile.At(num67, num68).Type] && Main.tile.At(num67, num68 - 1).Active && Main.tileDungeon[(int)Main.tile.At(num67, num68 - 1).Type] && Main.tile.At(num67, num68 + 1).Active && Main.tileDungeon[(int)Main.tile.At(num67, num68 + 1).Type])
						{
							...
							if (flag5 && (!Main.tile.At(num67, num68 - 1).Active & !Main.tile.At(num67, num68 - 2).Active & !Main.tile.At(num67, num68 - 3).Active))
							{
								...
								if (num72 > 5)
								{
									for (int num74 = WorldMod.genRand.Next(1, 4); num74 > 0; num74--)
									{
										Main.tile.At(num67, num68).SetActive(true);
										Main.tile.At(num67, num68).SetType(19);
										if (flag6)
										{
											WorldMod.PlaceTile(num67, num68 - 1, 50, true, false, -1, 0);
											if (WorldMod.genRand.Next(50) == 0 && Main.tile.At(num67, num68 - 1).Type == 50)
											{
									...
									num12 = 0;
									num14++;
									if (!flag6 && WorldMod.genRand.Next(2) == 0)
									{
										num67 = num73;
										num68--;
										int num75 = WorldMod.genRand.Next(2);
										if (num75 == 0)
										{
											num75 = 13;
										}
										...
										WorldMod.PlaceTile(num67, num68, num75, true, false, -1, 0);
				...
				for (int num76 = 0; num76 < numDRooms; num76++)
				{
					...
					while (num77 < 1000)
					{
						...
						int i2 = dRoomX[num76] + WorldMod.genRand.Next(-num78, num78 + 1);
						int j2 = dRoomY[num76] + WorldMod.genRand.Next(-num78, num78 + 1);
						int num79 = 0;
						int num80 = num76;
						switch (num80)
						{
						...
						if (num79 == 0 && WorldMod.genRand.Next(2) == 0)
						{
							num77 = 1000;
						}
						else
				...
				{
					num12++;
					int num81 = WorldMod.genRand.Next(dMinX, dMaxX);
					int num82 = WorldMod.genRand.Next(dMinY, dMaxY);
					if ((int)Main.tile.At(num81, num82).Wall == wallType)
					{
						...
						while (num83 > dMinY)
						{
							if (Main.tile.At(num81, num83 - 1).Active && (int)Main.tile.At(num81, num83 - 1).Type == tileType)
							{
								...
								WorldMod.Place1x2Top(num81, num83, 42);
		...
		public static void DungeonStairs(int i, int j, int tileType, int wallType)
		{
			...
			double num = (double)WorldMod.genRand.Next(5, 9);
			int num2 = 1;
			Vector2 value2;
			value2.X = (float)i;
			value2.Y = (float)j;
			int k = WorldMod.genRand.Next(10, 30);
			if (i > dEntranceX)
			{
				num2 = -1;
			}
			...
			else if (WorldMod.genRand.Next(3) == 0)
			{
				value.Y *= 2f;
			}
			while (k > 0)
			{
				k--;
				int num3 = (int)((double)value2.X - num - 4.0 - (double)WorldMod.genRand.Next(6));
				int num4 = (int)((double)value2.X + num + 4.0 + (double)WorldMod.genRand.Next(6));
				int num5 = (int)((double)value2.Y - num - 4.0);
				int num6 = (int)((double)value2.Y + num + 4.0 + (double)WorldMod.genRand.Next(6));
				if (num3 < 0)
				{
					num3 = 0;
				}
				...
				{
					dSurface = true;
					TileRunner(num8, (int)((double)value2.Y - num - 6.0 + (double)num9), (double)WorldMod.genRand.Next(25, 35), WorldMod.genRand.Next(10, 20), -1, false, 0f, -1f, false, true);
				}
				...
				for (int n = num3 + 1; n < num4 - 1; n++)
				{
					...
					{
						WorldMod.PlaceWall(n, num10, wallType, true);
					}
				}
				int num11 = 0;
				if (WorldMod.genRand.Next((int)num) == 0)
				{
					num11 = WorldMod.genRand.Next(1, 3);
				}
				...
				for (int num12 = num3; num12 < num4; num12++)
				{
					for (int num13 = num5; num13 < num6; num13++)
					{
						...
						WorldMod.PlaceWall(num12, num13, wallType, true);
					}
				}
				if (dSurface)
				{
		...
		{
			Vector2 value = default(Vector2);
			double num = (double)WorldMod.genRand.Next(4, 6);
			...
			value3.X = (float)i;
			value3.Y = (float)j;
			int k = WorldMod.genRand.Next(35, 80);
			if (forceX)
			{
				k += 20;
				lastDungeonHall = default(Vector2);
			}
			else if (WorldMod.genRand.Next(5) == 0)
			{
				num *= 2.0;
				k /= 2;
			}
			...
			if (!forceX)
			{
				if (value3.X > (float)(WorldMod.lastMaxTilesX - 200))
				{
					num2 = -1;
					vector.Y = 0f;
					vector.X = (float)num2;
				...
				else if (value3.Y > (float)(WorldMod.lastMaxTilesY - 300))
				{
					num2 = -1;
					num += 1.0;
					value.Y = (float)num2;
			...
			while (k > 0)
			{
				...
				k--;
				int num3 = (int)((double)value3.X - num - 4.0 - (double)WorldMod.genRand.Next(6));
				int num4 = (int)((double)value3.X + num + 4.0 + (double)WorldMod.genRand.Next(6));
				int num5 = (int)((double)value3.Y - num - 4.0 - (double)WorldMod.genRand.Next(6));
				int num6 = (int)((double)value3.Y + num + 4.0 + (double)WorldMod.genRand.Next(6));
				if (num3 < 0)
				{
					num3 = 0;
				}
				...
				for (int n = num3 + 1; n < num4 - 1; n++)
				{
					...
					{
						WorldMod.PlaceWall(n, num7, wallType, true);
					}
				}
				int num8 = 0;
				if (value.Y == 0f && WorldMod.genRand.Next((int)num + 1) == 0)
				{
					num8 = WorldMod.genRand.Next(1, 3);
				}
				else if (value.X == 0f && WorldMod.genRand.Next((int)num - 1) == 0)
				{
					num8 = WorldMod.genRand.Next(1, 3);
				}
				else if (WorldMod.genRand.Next((int)num * 3) == 0)
				{
					num8 = WorldMod.genRand.Next(1, 3);
				}
		...
		{
			double num = (double)WorldMod.genRand.Next(15, 30);
			Vector2 value;
			value.X = (float)WorldMod.genRand.Next(-10, 11) * 0.1f;
			value.Y = (float)WorldMod.genRand.Next(-10, 11) * 0.1f;
			Vector2 value2;
			value2.X = (float)i;
			value2.Y = (float)j - (float)num / 2f;
			int k = WorldMod.genRand.Next(10, 20);
			...
			while (k > 0)
			{
				...
				value2 += value;
				value.X += (float)WorldMod.genRand.Next(-10, 11) * 0.05f;
				value.Y += (float)WorldMod.genRand.Next(-10, 11) * 0.05f;
				if (value.X > 1f)
				{
					value.X = 1f;
				}
		...
		public static void DungeonEnt(int i, int j, int tileType, int wallType)
		{
			...
			int num4 = (int)((double)vector.X - num * 0.60000002384185791 - (double)WorldMod.genRand.Next(2, 5));
			int num5 = (int)((double)vector.X + num * 0.60000002384185791 + (double)WorldMod.genRand.Next(2, 5));
			int num6 = (int)((double)vector.Y - num2 * 0.60000002384185791 - (double)WorldMod.genRand.Next(2, 5));
			int num7 = (int)((double)vector.Y + num2 * 0.60000002384185791 + (double)WorldMod.genRand.Next(8, 16));
			if (num4 < 0)
			{
				num4 = 0;
			}
			...
			for (int k = num4; k < num5; k++)
			{
				for (int l = num6; l < num7; l++)
				{
					...
					if ((int)Main.tile.At(k, l).Wall != wallType)
					{
						...
						{
							WorldMod.PlaceWall(k, l, wallType, true);
						}
			...
			int num8 = num4;
			int num9 = num4 + 5 + WorldMod.genRand.Next(4);
			int num10 = num6 - 3 - WorldMod.genRand.Next(3);
			int num11 = num6;
			for (int m = num8; m < num9; m++)
			{
			...
			num8 = num5 - 5 - WorldMod.genRand.Next(4);
			num9 = num5;
			num10 = num6 - 3 - WorldMod.genRand.Next(3);
			num11 = num6;
			for (int num12 = num8; num12 < num9; num12++)
			{
			...
			int num14 = 1 + WorldMod.genRand.Next(2);
			int num15 = 2 + WorldMod.genRand.Next(4);
			int num16 = 0;
			...
			for (int num19 = num4; num19 < num5; num19++)
			{
				...
				{
					WorldMod.PlaceWall(num19, num20, 2, true);
				}
			}
			...
			for (int num21 = num4; num21 < num5; num21++)
			{
				...
				{
					WorldMod.PlaceWall(num21, num22, wallType, true);
				}
			}
			...
			vector.Y -= (float)num2 * 0.5f;
			num4 = (int)((double)vector.X - num * 0.60000002384185791 - (double)WorldMod.genRand.Next(1, 3));
			num5 = (int)((double)vector.X + num * 0.60000002384185791 + (double)WorldMod.genRand.Next(1, 3));
			num6 = (int)((double)vector.Y - num2 * 0.60000002384185791 - (double)WorldMod.genRand.Next(1, 3));
			num7 = (int)((double)vector.Y + num2 * 0.60000002384185791 + (double)WorldMod.genRand.Next(6, 16));
			if (num4 < 0)
			{
				num4 = 0;
			}
			...
			for (int num29 = num4; num29 < num5; num29++)
			{
				...
				{
					WorldMod.PlaceWall(num29, num30, 2, true);
				}
			}
			num4 = (int)((double)vector.X - num * 0.5);
			num5 = (int)((double)vector.X + num * 0.5);
			...
			num9 = num8 + 5 + WorldMod.genRand.Next(4);
			num10 = num6 - 3 - WorldMod.genRand.Next(3);
			num11 = num6;
			...
			num14 = 1 + WorldMod.genRand.Next(2);
			num15 = 2 + WorldMod.genRand.Next(4);
			num16 = 0;
			if (num3 < 0)
			{
				num5++;
			...
			for (int num49 = num4; num49 < num5; num49++)
			{
				...
				{
					WorldMod.PlaceWall(num49, num50, wallType, true);
				}
				num16++;
				if (num16 >= num15)
				{
			...
			WorldMod.PlaceTile((int)vector.X, (int)vector.Y + 1, 10, false, false, -1, 0);
		}
		...
		public static void ChasmRunnerSideways(int i, int j, int direction, int steps)
		{
			...
			value.Y = (float)j;
			Vector2 value2;
			value2.X = (float)WorldMod.genRand.Next(10, 21) * 0.1f * (float)direction;
			value2.Y = (float)WorldMod.genRand.Next(-10, 10) * 0.01f;
			double num2 = (double)(WorldMod.genRand.Next(5) + 7);
			while (num2 > 0.0)
			{
				if (num > 0f)
				{
					num2 += (double)WorldMod.genRand.Next(3);
					num2 -= (double)WorldMod.genRand.Next(3);
					if (num2 < 7.0)
					{
						num2 = 7.0;
				...
				{
					num2 -= (double)WorldMod.genRand.Next(4);
				}
				...
				for (int k = num3; k < num4; k++)
				{
					...
					{
						if ((double)(Math.Abs((float)k - value.X) + Math.Abs((float)l - value.Y)) < num2 * 0.5 * (1.0 + (double)WorldMod.genRand.Next(-10, 11) * 0.015) && Main.tile.At(k, l).Type != 31 && Main.tile.At(k, l).Type != 22)
						{
				...
				value += value2;
				value2.Y += (float)WorldMod.genRand.Next(-10, 10) * 0.1f;
				if (value.Y < (float)(j - 20))
				{
					value2.Y += (float)WorldMod.genRand.Next(20) * 0.01f;
				}
				if (value.Y > (float)(j + 20))
				{
					value2.Y -= (float)WorldMod.genRand.Next(20) * 0.01f;
				...
				value2.X += (float)WorldMod.genRand.Next(-10, 11) * 0.01f;
				if (direction == -1)
				{
				...
				for (int m = num3; m < num4; m++)
				{
					...
					{
						if ((double)(Math.Abs((float)m - value.X) + Math.Abs((float)n - value.Y)) < num2 * 1.1 * (1.0 + (double)WorldMod.genRand.Next(-10, 11) * 0.015) && Main.tile.At(m, n).Wall != 3)
						{
							if (Main.tile.At(m, n).Type != 25 && n > j + WorldMod.genRand.Next(3, 20))
							{
								Main.tile.At(m, n).SetActive(true);
							}
							Main.tile.At(m, n).SetActive(true);
				...
				for (int num7 = num3; num7 < num4; num7++)
				{
					...
					{
						if ((double)(Math.Abs((float)num7 - value.X) + Math.Abs((float)num8 - value.Y)) < num2 * 1.1 * (1.0 + (double)WorldMod.genRand.Next(-10, 11) * 0.015) && Main.tile.At(num7, num8).Wall != 3)
						{
							...
							WorldMod.PlaceWall(num7, num8, 3, true);
						}
					}
				}
			}
			if (WorldMod.genRand.Next(3) == 0)
			{
				...
				TileRunner(num9, num10, (double)WorldMod.genRand.Next(2, 6), WorldMod.genRand.Next(3, 7), 22, false, 0f, 0f, false, true);
			}
		}
		...
		public static void ChasmRunner(int i, int j, int steps, bool makeOrb = false)
		{
			...
			value.Y = (float)j;
			Vector2 value2;
			value2.X = (float)WorldMod.genRand.Next(-10, 11) * 0.1f;
			value2.Y = (float)WorldMod.genRand.Next(11) * 0.2f + 0.5f;
			int num2 = 5;
			double num3 = (double)(WorldMod.genRand.Next(5) + 7);
			while (num3 > 0.0)
			{
				if (num > 0f)
				{
					num3 += (double)WorldMod.genRand.Next(3);
					num3 -= (double)WorldMod.genRand.Next(3);
					if (num3 < 7.0)
					{
						num3 = 7.0;
				...
				{
					num3 -= (double)WorldMod.genRand.Next(4);
				}
				if ((double)value.Y > Main.rockLayer && num > 0f)
				{
					num = 0f;
				...
				{
					flag = true;
					ChasmRunnerSideways((int)value.X, (int)value.Y, -1, WorldMod.genRand.Next(20, 40));
					ChasmRunnerSideways((int)value.X, (int)value.Y, 1, WorldMod.genRand.Next(20, 40));
				}
				int num4;
				int num5;
				...
				if (num > (float)num2)
				{
					...
					for (int k = num4; k < num5; k++)
					{
						for (int l = num6; l < num7; l++)
						{
							if ((double)(Math.Abs((float)k - value.X) + Math.Abs((float)l - value.Y)) < num3 * 0.5 * (1.0 + (double)WorldMod.genRand.Next(-10, 11) * 0.015) && Main.tile.At(k, l).Type != 31 && Main.tile.At(k, l).Type != 22)
							{
								Main.tile.At(k, l).SetActive(false);
							}
						}
				...
				if (num <= 0f)
				{
					...
					else if (!flag3)
					{
						...
						while (!flag4)
						{
							int num9 = WorldMod.genRand.Next((int)value.X - 25, (int)value.X + 25);
							int num10 = WorldMod.genRand.Next((int)value.Y - 50, (int)value.Y);
							if (num9 < 5)
							{
								num9 = 5;
							}
							...
							{
								WorldMod.Place3x2(num9, num10, 26);
				...
				for (int m = num4; m < num5; m++)
				{
					...
					{
						if ((double)(Math.Abs((float)m - value.X) + Math.Abs((float)n - value.Y)) < num3 * 1.1 * (1.0 + (double)WorldMod.genRand.Next(-10, 11) * 0.015))
						{
							if (Main.tile.At(m, n).Type != 25 && n > j + WorldMod.genRand.Next(3, 20))
							{
								Main.tile.At(m, n).SetActive(true);
				...
				for (int num11 = num4; num11 < num5; num11++)
				{
					...
					{
						if ((double)(Math.Abs((float)num11 - value.X) + Math.Abs((float)num12 - value.Y)) < num3 * 1.1 * (1.0 + (double)WorldMod.genRand.Next(-10, 11) * 0.015))
						{
							...
							if (num12 > j + WorldMod.genRand.Next(3, 20))
							{
								WorldMod.PlaceWall(num11, num12, 3, true);
							}
						}
					}
				}
		...
		{
			double num = (double)WorldMod.genRand.Next(5, 11);
			Vector2 value;
			value.X = (float)i;
			value.Y = (float)j;
			Vector2 value2;
			value2.X = (float)WorldMod.genRand.Next(-10, 11) * 0.1f;
			value2.Y = (float)WorldMod.genRand.Next(10, 20) * 0.1f;
			int num2 = 0;
			bool flag = true;
			while (flag)
			{
				...
				JungleX = (int)value.X;
				num += (double)((float)WorldMod.genRand.Next(-20, 21) * 0.1f);
				if (num < 5.0)
				{
					num = 5.0;
				}
				...
				for (int k = num5; k < num6; k++)
				{
					...
					{
						if ((double)(Math.Abs((float)k - value.X) + Math.Abs((float)l - value.Y)) < num * 0.5 * (1.0 + (double)WorldMod.genRand.Next(-10, 11) * 0.015))
						{
				...
				num2++;
				if (num2 > 10 && WorldMod.genRand.Next(50) < num2)
				{
					num2 = 0;
					int num9 = -2;
					if (WorldMod.genRand.Next(2) == 0)
					...
					TileRunner((int)value.X, (int)value.Y, (double)WorldMod.genRand.Next(3, 20), WorldMod.genRand.Next(10, 100), -1, false, (float)num9, 0f, false, true);
				}
				value += value2;
				value2.Y += (float)WorldMod.genRand.Next(-10, 11) * 0.01f;
				if (value2.Y > 0f)
				{
					value2.Y = 0f;
				}
				...
				{
					value2.X += (float)WorldMod.genRand.Next(5, 21) * 0.1f;
				}
				if (value.X > (float)(i + 200))
				{
					value2.X -= (float)WorldMod.genRand.Next(5, 21) * 0.1f;
		...
		public static void TileRunner(int i, int j, double strength, int steps, int type, bool addTile = false, float speedX = 0f, float speedY = 0f, bool noYChange = false, bool overRide = true)
		{
			...
			Vector2 value2;
			value2.X = (float)WorldMod.genRand.Next(-10, 11) * 0.1f;
			value2.Y = (float)WorldMod.genRand.Next(-10, 11) * 0.1f;
			...
			while (num > 0.0 && num2 > 0f)
			{
				...
				for (int k = num3; k < num4; k++)
				{
					for (int l = num5; l < num6; l++)
					{
						if ((double)(Math.Abs((float)k - value.X) + Math.Abs((float)l - value.Y)) < strength * 0.5 * (1.0 + (double)WorldMod.genRand.Next(-10, 11) * 0.015))
						{
							if (type < 0)
							{
								if (type == -2 && Main.tile.At(k, l).Active && (l < WorldMod.waterLine || l > WorldMod.lavaLine))
								{
									Main.tile.At(k, l).SetLiquid(255);
									if (l > WorldMod.lavaLine)
									{
							...
							{
								if ((overRide || !Main.tile.At(k, l).Active) && (type != 40 || Main.tile.At(k, l).Type != 53) && (!Main.tileStone[type] || Main.tile.At(k, l).Type == 1) && Main.tile.At(k, l).Type != 45 && (Main.tile.At(k, l).Type != 1 || type != 59 || (double)l >= Main.worldSurface + (double)WorldMod.genRand.Next(-50, 50)))
								{
								...
								if (type == 59 && l > WorldMod.waterLine && Main.tile.At(k, l).Liquid > 0)
								{
									Main.tile.At(k, l).SetLava(false);
									Main.tile.At(k, l).SetLiquid(0);
								}
				...
				if (num > 50.0)
				{
					value += value2;
					num2 -= 1f;
					value2.Y += (float)WorldMod.genRand.Next(-10, 11) * 0.05f;
					value2.X += (float)WorldMod.genRand.Next(-10, 11) * 0.05f;
					if (num > 100.0)
					{
						value += value2;
						num2 -= 1f;
		...
		{
			double num = (double)WorldMod.genRand.Next(80, 120);
			float num2 = (float)WorldMod.genRand.Next(20, 25);
			Vector2 value;
			value.X = (float)i;
			value.Y = (float)j;
			Vector2 value2;
			value2.X = (float)WorldMod.genRand.Next(-20, 21) * 0.2f;
			while (value2.X > -2f && value2.X < 2f)
			{
				value2.X = (float)WorldMod.genRand.Next(-20, 21) * 0.2f;
			}
			value2.Y = (float)WorldMod.genRand.Next(-20, -10) * 0.02f;
			while (num > 0.0 && num2 > 0f)
			{
				num -= (double)WorldMod.genRand.Next(4);
				num2 -= 1f;
				int num3 = (int)((double)value.X - num * 0.5);
				int num4 = (int)((double)value.X + num * 0.5);
				int num5 = (int)((double)value.Y - num * 0.5);
				...
				double num7 = num * (double)WorldMod.genRand.Next(80, 120) * 0.01;
				float num8 = value.Y + 1f;
				for (int k = num3; k < num4; k++)
				{
					if (WorldMod.genRand.Next(2) == 0)
					{
						num8 += (float)WorldMod.genRand.Next(-1, 2);
					}
					if (num8 < value.Y)
					{
						num8 = value.Y;
				...
				TileRunner(WorldMod.genRand.Next(num3 + 10, num4 - 10), (int)((double)value.Y + num7 * 0.1 + 5.0), (double)WorldMod.genRand.Next(5, 10), WorldMod.genRand.Next(10, 15), 0, true, 0f, 2f, true, true);
				...
				num7 = num * (double)WorldMod.genRand.Next(80, 120) * 0.01;
				for (int m = num3; m < num4; m++)
				{
					for (int n = num5; n < num6; n++)
					{
		...
		{
			byte type = (byte)WorldMod.genRand.Next(45, 48);
			byte wall = (byte)WorldMod.genRand.Next(10, 13);
			...
			int num2 = WorldMod.genRand.Next(7, 12);
			int num3 = WorldMod.genRand.Next(5, 7);
			...
			int num7 = (int)(vector.Y + 2f + (float)WorldMod.genRand.Next(3, 5));
			if (num4 < 0)
			{
				num4 = 0;
			}
			...
			WorldMod.PlaceTile(num9, num10, 10, true, false, -1, 0);
			int contain = 0;
			int num12 = houseCount;
			if (num12 > 2)
			{
				num12 = WorldMod.genRand.Next(3);
			}
			if (num12 == 0)
			{
				contain = 159;
		...
		{
			double num = (double)WorldMod.genRand.Next(80, 120);
			float num2 = (float)WorldMod.genRand.Next(40, 55);
			Vector2 value;
			value.X = (float)i;
			value.Y = (float)j + num2 / 2f;
			Vector2 value2;
			value2.X = (float)WorldMod.genRand.Next(-10, 11) * 0.1f;
			value2.Y = (float)WorldMod.genRand.Next(-20, -10) * 0.1f;
			while (num > 0.0 && num2 > 0f)
			{
				num -= (double)WorldMod.genRand.Next(4);
				num2 -= 1f;
		...
		{
			double num = (double)WorldMod.genRand.Next(25, 50);
			double num2 = num;
			float num3 = (float)WorldMod.genRand.Next(30, 80);
			if (WorldMod.genRand.Next(5) == 0)
			{
				num *= 1.5;
				num2 *= 1.5;
			...
			while (num > 0.0 && num3 > 0f)
			{
				...
				num -= (double)WorldMod.genRand.Next(3);
				num3 -= 1f;
				int num4 = (int)((double)value.X - num * 0.5);
				int num5 = (int)((double)value.X + num * 0.5);
				int num6 = (int)((double)value.Y - num * 0.5);
				...
				num2 = num * (double)WorldMod.genRand.Next(80, 120) * 0.01;
				for (int k = num4; k < num5; k++)
				{
					for (int l = num6; l < num7; l++)
					{
		...
		{
			double num = (double)WorldMod.genRand.Next(40, 70);
			double num2 = num;
			float num3 = (float)WorldMod.genRand.Next(10, 20);
			if (WorldMod.genRand.Next(5) == 0)
			{
				num *= 1.5;
				num2 *= 1.5;
		...
		{
			double num = (double)WorldMod.genRand.Next(7, 15);
			int num2 = 1;
			if (WorldMod.genRand.Next(2) == 0)
			{
				num2 = -1;
			...
			value.X = (float)i;
			value.Y = (float)j;
			int k = WorldMod.genRand.Next(20, 40);
			Vector2 value2;
			value2.Y = (float)WorldMod.genRand.Next(10, 20) * 0.01f;
			value2.X = (float)num2;
			while (k > 0)
			{
				k--;
		...
		{
			double num = (double)WorldMod.genRand.Next(7, 12);
			int num2 = 1;
			if (WorldMod.genRand.Next(2) == 0)
			{
				num2 = -1;
			...
			for (int i = 0; i < Main.maxTilesX; i++)
			{
				for (int j = 1; j < Main.maxTilesY; j++)
				{
					if (Main.tile.At(i, j).Type == 2 && Main.tile.At(i, j).Active)
					{
						...
						{
							WorldMod.PlaceTile(i, j - 1, 3, true, false, -1, 0);
						}
					}
					else if (Main.tile.At(i, j).Type == 23 && Main.tile.At(i, j).Active && !Main.tile.At(i, j - 1).Active)
					{
						WorldMod.PlaceTile(i, j - 1, 24, true, false, -1, 0);
					}
				}
			}
		}
		...
		public static bool AddLifeCrystal(int i, int j)
		{
			...
			while (k < Main.maxTilesY)
			{
				if (Main.tile.At(i, k).Active && Main.tileSolid[(int)Main.tile.At(i, k).Type])
				{
					...
					if (!WorldMod.EmptyTileCheck(i - 1, i, num - 1, num, -1))
					{
						return false;
					}
		...
		{
			int num = WorldMod.genRand.Next(8, 20);
			int num2 = WorldMod.genRand.Next(3);
			int num3 = WorldMod.genRand.Next(7);
			int num4 = j;
			for (int k = 0; k < num2; k++)
			{
				int num5 = WorldMod.genRand.Next(5, 9);
			...
			{
				int num6 = WorldMod.genRand.Next(5, 9);
				num4 += num6;
			...
			for (int m = i - num / 2; m <= i + num / 2; m++)
			{
				...
				int num7 = 6 + WorldMod.genRand.Next(3);
			...
			while ((Main.tile.At(i, num4).Active && Main.tile.At(i, num4).Type == 76) || Main.tile.At(i, num4).Wall == 13)
			{
				...
				{
					int num10 = WorldMod.genRand.Next(i - num / 2 + 1, i + num / 2 - 1);
					int num11 = WorldMod.genRand.Next(i - num / 2 + 1, i + num / 2 - 1);
					if (num10 > num11)
					{
						int num12 = num10;
						num10 = num11;
			...
			{
				int num16 = WorldMod.genRand.Next(i - num / 2, i + num / 2 + 1);
				int num17 = WorldMod.genRand.Next(num8, num9);
				int num18 = WorldMod.genRand.Next(3, 8);
		...
		public static bool GrowEpicTree(int x, int y)
		{
			...
			if (Main.tile.At(x, freeTilesAbove).Active
				...
				&& rightTile.Type == 2)
			{
				if (WorldMod.EmptyTileCheck(x - TREE_RADIUS, x + TREE_RADIUS, freeTilesAbove - 55, freeTilesAbove - 1, 20))
				{
					WorldMod.GrowTreeShared(x, y, freeTilesAbove, 20, 30);
					return true;
				}
			}
			return false;
