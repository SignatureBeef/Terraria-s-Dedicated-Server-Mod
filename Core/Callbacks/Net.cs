...
//            for (int i = 0; i < 255; i++)
//            {
//                if (OTA.Callbacks.Netplay.slots[i].state == SlotState.PLAYING)
//                {
...
//            for (int i = 0; i < 256; i++)
//            {
//                if ((/*NewNetMessage.buffer[i].broadcast ||*/ OTA.Callbacks.Netplay.slots[i].state >= SlotState.SENDING_TILES) && OTA.Callbacks.Netplay.slots[i].Connected)
//                {
//                    int num = x / 200;
//                    int num2 = y / 150;
//                    if (OTA.Callbacks.Netplay.slots[i].TileSections[num, num2])
//                    {
...
//                    {
//                        string text = OTA.Callbacks.Netplay.slots[i].conn.RemoteAddress;
//                        string a = text;
...
//                    if (!OTA.Callbacks.Netplay.slots[i].announced)
//                    {
//                        OTA.Callbacks.Netplay.slots[i].announced = true;
...
//                    if (OTA.Callbacks.Netplay.slots[i].announced)
//                    {
//                        OTA.Callbacks.Netplay.slots[i].announced = false;
//                        NewNetMessage.SendData(25, -1, i, OTA.Callbacks.Netplay.slots[i].oldName + " " + Lang.mp[20], 255, 255f, 240f, 20f, 0);
//                        if (Main.dedServ)
//                        {
//                            ProgramLog.Log(OTA.Callbacks.Netplay.slots[i].oldName + " " + Lang.mp[20]);
//                        }
//                    }
//                }
//            }
...
//        {
//            Server.Bans.Add(OTA.Callbacks.Netplay.slots[plr].conn.RemoteAddress);
//            //string text = OTA.Callbacks.Netplay.slots[plr].conn.RemoteAddress;
//            //string value = text;
