...
namespace tdsm.core.ServerCore
{
    public static class StringCache
    {
        ...
        public static string FindOrMake(ArraySegment<byte> b, bool isEncoded = false)
        {
            var s = Find(b);
            ...
            while (true)
            {
                length += b.Array[pos + b.Offset] & 0x7F;
                if (b.Array[pos++ + b.Offset] > 127)
                    length <<= 7;
                else break;
            }

            return System.Text.Encoding.UTF8.GetString(b.Array, b.Offset + 1, length);
        }
#endif
    }
}