...
namespace tdsm.core.Messages.In
{
    public class RequestTileMessage : SlotMessageHandler
    {
        ...
        public override void Process(int whoAmI, byte[] readBuffer, int length, int num)
        {
            ...
            ServerSlot serverSock = tdsm.api.Callbacks.NetplayCallback.slots[whoAmI] as ServerSlot;
            ...
            tdsm.api.Callbacks.NetplayCallback.slots[whoAmI].statusText2 = "is receiving tile data";
            tdsm.api.Callbacks.NetplayCallback.slots[whoAmI].statusMax += num19;
